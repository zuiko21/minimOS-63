...
MEMLOCK		EQU	FREE+3			; allocate memory at a certain address, new 20170524
RELEASE		EQU	MEMLOCK+3		; release ALL memory blocks belonging to some PID, new 20161115 *** worth it???
; multitasking...
...
API_SIZE	= SET_CURR+3		; *** set just after the LAST API call ***
...
BR_BORN		EQU 160		; added a fifth state for forked-but-not-yet-loaded braids (in order NOT to start them abnormally)
BR_MASK		EQU 224		; as it sets highest 3 bits but NOT those for SIGTERM handler, new 20161117
...
PW_NMI		EQU 10		; invoke NMI
PW_IRQ		EQU 12		; invoke IRQ
